...
parser.add_argument("--train_data", type=str, default="C:/Users/Alex/Desktop/数据科学导论作业/week7/Chinese-Character-Recognition-main/data/train_data", help="path of train data")
parser.add_argument("--test_data", type=str, default="C:/Users/Alex/Desktop/数据科学导论作业/week7/Chinese-Character-Recognition-main/data/test_data", help="path of test data")
